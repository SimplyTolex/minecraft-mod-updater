...
github_link = "https://github.com/SimplyTolex/minecraft-mod-updater"
about_text = f"""This is where some kind of message about graditude should be,
but I couldn't come up with anything. ¯\_(ツ)_/¯
Thanks.. I guess!"""
